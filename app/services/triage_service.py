...
from app.core.exceptions import AppointmentNotFoundError, BaseBusinessException
from app.models.appointments import Triage, AppointmentStatus
...
async def create_triage(
    db: AsyncSession, appointment_id: UUID, triage_data: TriageCreate, nurse_id: UUID
) -> Triage:
    """
...
async def update_triage(
    db: AsyncSession, appointment_id: UUID, triage_data: TriageUpdate
) -> Triage:
    """
