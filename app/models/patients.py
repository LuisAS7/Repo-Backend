...
from sqlalchemy import String, Date, Boolean, ForeignKey, Table, Column
...
class Patient(Base, TimestampMixin):
    ...
    allergies: Mapped[list["Allergy"]] = relationship(secondary=patient_allergy)
    chronic_diseases: Mapped[list["ChronicDisease"]] = relationship(secondary=patient_disease)
